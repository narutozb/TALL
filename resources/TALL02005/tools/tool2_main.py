...
from tools.manager import CustomTool2Manager
...
class MainUI2(QtWidgets.QDialog):
    """
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("自定义 UI 窗口2")
        self.resize(300, 200)
        self.initUI()
    ...
    def initUI(self):
        ...
        CustomTool2Manager.add_job(event=['SelectionChanged', self.print_selected_objects])

        CustomTool2Manager.run_jobs()

    def button_function(self):
        print(CustomTool2Manager.registration_script_job_list)

    def print_selected_objects(self, ):
        print('print_selected_objects...')

    def closeEvent(self, arg__1):
        CustomTool2Manager.kill_jobs()
        print(arg__1)
